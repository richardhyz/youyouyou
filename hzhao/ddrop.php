...
<div id="itemid" style="display:none">ddrop</div>
...
<div class="single_top">
	 <div class="container"> 
						...
						<ul id="etalage">
							<li>
								<a href="optionallink.html">
									<img class="etalage_thumb_image" src="../product_us/ddrop1.jpg" class="img-responsive" />
									<img class="etalage_source_image" src="../product_us/ddrop1.jpg" class="img-responsive" title="" />
								</a>
							</li>
							<li>
								<img class="etalage_thumb_image" src="../product_us/ddrop2.png" class="img-responsive" />
								<img class="etalage_source_image" src="../product_us/ddrop2.png" class="img-responsive" title="" />
							</li> 
							<li>
								<img class="etalage_thumb_image" src="../product_us/ddrop.png" class="img-responsive"  />
								<img class="etalage_source_image" src="../product_us/ddrop.png"class="img-responsive"  />
							</li>
						    <li>
								<img class="etalage_thumb_image" src="../product_us/ddrop3.jpg" class="img-responsive"  />
								<img class="etalage_source_image" src="../product_us/ddrop3.jpg"class="img-responsive"  />
							</li>
						</ul>
						 <div class="clearfix"></div>		
				  </div> 
				  <div class="desc1 span_3_of_2">
					<h1>Ddrops婴儿维生素D 滴剂</h1>
					<p style="font-size: 16px"> 又一款超级明星产品：Baby D drops. 补充宝宝维生素D只要一小滴就足够了。北美医生都会建议妈妈给宝宝用呢。加拿大儿科医生推荐。不多介绍了，懂货的妈妈入哦!</p>
        ...
        <input id="input-22"  value="0" type="number" class="rating" min=0 max=5 step=0.5 data-rtl=1 data-container-class='text-right' data-glyphicon=0 data-size="xs">
				...
				<div class="clearfix"></div>
			 <ul class="menu_drop">
				<li class="item1"><a href="#"><img src="images_product/product_arrow.png">产品特点</a>
					<ul>
						<li class="subitem1"> amazon评价五星的产品，在其health& personal care里面也一直是很畅销的婴儿保健品；</br>
											  有效成份：维生素D3（colecalciferol）10微克（400国际单位）
辅料成份：椰子油。
</li>
						<li class="subitem2">  Ddrops 维生素D滴液是纯天然植物提取，无味、无臭，不含人工色素、香精、糖、防腐剂等添加剂。不含小麦、牛奶、玉米、花生、大豆等易于过敏的成分。可以放心服用。</a></li>
						<li class="subitem3"> 含有维生素A，防治贫血和感冒</br>　自从出生后第7--10天开始，母乳喂养的婴儿每天要添加维生素D400单位，预防维生素D缺乏性佝偻病，因母乳中维生素D的含量太少，不能满足婴儿生长发育的需要。 </br> 用配方奶粉喂养的婴儿，则不必另外加维生素D。</li>
					</ul>
				</li>
				<li class="item2"><a href="#"><img src="images_product/product_arrow.png">公司介绍</a>
					<ul>
						
					    <li class="subitem2"> <a href="#"> D drop 是目前世界最畅销的母婴用品之一， 产自加拿大</a></li>
						<li class="subitem3"><a href="#"> 产品作用</br>
						维生素D的主要功能是调节体内钙、磷代谢，维持血钙和血磷的水平，从而维持牙齿和骨骼的正常生长就发育。儿童缺乏维生素D，易发生佝偻病，过多服用维生素D将引起急性中毒。 维生素D是一种脂溶性维生素，有五种化合物，对健康关系较密切的是维生素D2和维生素D3。
</a></li>
				...
				<li class="item3"><a href="#"><img src="images_product/product_arrow.png">评论 (9)</a>
					<ul>
						...
						My pediatrician told us to start our newborn on Vitamin D drops, so we chose these since you only have to give them one drop, not a whole syringe full. You just put it on your nipple and let the baby get it while they feed. Very easy!</li>
				...
				<li class="item4"><a href="#"><img src="images_product/product_arrow.png">用法用量</a>
					<ul>
					   ...
					   每天用量1滴，打开盖子，瓶口向下，不需要摇晃，滴一滴在妈妈的奶头上，或奶嘴上，让宝宝至少吮吸30秒。</br>　						
					    也可以把滴液滴入奶粉，果汁或其它食物里。存放时瓶口朝上，盖子拧紧，存放在15度到30度的环境里</br>　
                       本款适合2岁以下婴儿服用。
                        </li>
						<li class="subitem3">○　注意事项：</br>
						很多麻麻会问怎么瓶子里不满，我第一次拿到手的时候也很吃惊，然后再仔细看只有2.5ml，就理解啦。这款维生素D，不是漏掉，是本身就这样。液体容量只有瓶子的4分之一</br>
